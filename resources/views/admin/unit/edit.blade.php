                                ...
                                <form class="needs-validation" novalidate action="{{route('unit.update',$unit->id)}}" method="post">
                                    ...
                                    <div class="form-row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" id="validationCustom011" value="{{$unit->name}}" required>
                                    ...
                                    <div class="form-row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                            ...
                                            <textarea name="description" class="form-control" placeholder="Unit Description" cols="30" rows="10">{{$unit->description}}</textarea>
                                        </div>
